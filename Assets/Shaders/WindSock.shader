...
/*SF_DATA;ver:1.03;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:2,uamb:True,mssp:False,lmpd:True,lprd:False,rprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:2,dpts:2,wrdp:True,dith:2,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:4043,x:32719,y:32712,varname:node_4043,prsc:2|diff-1844-OUT,spec-9363-OUT,gloss-6164-OUT;n:type:ShaderForge.SFN_Color,id:4419,x:32184,y:32508,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_4419,prsc:2,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Multiply,id:9363,x:32459,y:32722,varname:node_9363,prsc:2|A-833-RGB,B-3949-OUT;n:type:ShaderForge.SFN_Slider,id:3949,x:32129,y:32839,ptovrint:False,ptlb:Specular Power,ptin:_SpecularPower,varname:node_3174,prsc:2,min:0,cur:2.112423,max:5;n:type:ShaderForge.SFN_Slider,id:6164,x:32362,y:32948,ptovrint:False,ptlb:SpecularAmount,ptin:_SpecularAmount,varname:node_6417,prsc:2,min:1,cur:0.2947466,max:-0.5;n:type:ShaderForge.SFN_Color,id:833,x:32157,y:32667,ptovrint:False,ptlb:Specular color,ptin:_Specularcolor,varname:node_833,prsc:2,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Tex2d,id:2460,x:32285,y:32313,ptovrint:False,ptlb:Texture,ptin:_Texture,varname:node_2460,prsc:2,ntxv:2,isnm:False;n:type:ShaderForge.SFN_Add,id:6072,x:32428,y:32432,varname:node_6072,prsc:2|A-2460-RGB,B-4419-RGB;n:type:ShaderForge.SFN_ValueProperty,id:916,x:32351,y:32603,ptovrint:False,ptlb:Brightness,ptin:_Brightness,varname:node_916,prsc:2,glob:False,v1:1;n:type:ShaderForge.SFN_Multiply,id:1844,x:32616,y:32547,varname:node_1844,prsc:2|A-6072-OUT,B-916-OUT;n:type:ShaderForge.SFN_Tex2d,id:2166,x:32207,y:32969,ptovrint:False,ptlb:Normal,ptin:_Normal,varname:node_2166,prsc:2,ntxv:0,isnm:False;proporder:4419-916-3949-6164-833-2460-2166;pass:END;sub:END;*/

Shader "Shader Forge/WindSock" {
    Properties {
        _Color ("Color", Color) = (0.5,0.5,0.5,1)
        _Brightness ("Brightness", Float ) = 1
        _SpecularPower ("Specular Power", Range(0, 5)) = 2.112423
        _SpecularAmount ("SpecularAmount", Range(1, -0.5)) = 0.2947466
